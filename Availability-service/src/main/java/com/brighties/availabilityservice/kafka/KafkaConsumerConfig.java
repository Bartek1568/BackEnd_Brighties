...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, SlotReservedEvent> consumerFactory() {
        ...
        JsonDeserializer<SlotReservedEvent> deserializer = new JsonDeserializer<>(SlotReservedEvent.class);
        deserializer.addTrustedPackages("com.brighties.reservationservice.event");
